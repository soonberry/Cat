...
struct R: Rswift.Validatable {
  ...
  struct segue {
    /// This struct is generated for `MyCatViewController`, and contains static references to 1 segues.
    struct myCatViewController {
      /// Segue identifier `loginSegue`.
      static let loginSegue: Rswift.StoryboardSegueIdentifier<UIKit.UIStoryboardSegue, MyCatViewController, LoginViewController> = Rswift.StoryboardSegueIdentifier(identifier: "loginSegue")
      
      /// Optionally returns a typed version of segue `loginSegue`.
      /// Returns nil if either the segue identifier, the source, destination, or segue types don't match.
      /// For use inside `prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?)`.
      static func loginSegue(segue: UIKit.UIStoryboardSegue) -> Rswift.TypedStoryboardSegueInfo<UIKit.UIStoryboardSegue, MyCatViewController, LoginViewController>? {
        return Rswift.TypedStoryboardSegueInfo(segueIdentifier: R.segue.myCatViewController.loginSegue, segue: segue)
      }
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct launchScreen: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "Cat On Cloud") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'Cat On Cloud' is used in storyboard 'LaunchScreen', but couldn't be loaded.") }
      }
    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let bundle = R.hostingBundle
      let myCat = StoryboardViewControllerResource<MyCatViewController>(identifier: "My Cat")
      let name = "Main"
      
      func myCat(_: Void = ()) -> MyCatViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: myCat)
      }
      ...
      static func validate() throws {
        ...
        if _R.storyboard.main().myCat() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'myCat' could not be loaded from storyboard 'Main' as 'MyCatViewController'.") }
      }
